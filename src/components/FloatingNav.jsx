      ...
      >
        ...
        <nav className="hidden md:flex items-center gap-1">
          {navLinks.map((link) => {
            ...
            const isTestimonialsActive = activeSection === "testimonials" && link.href === "#testimonials";
            ...
            const isActive =
              isHomeActive || isAboutActive || isProjectsActive || isTestimonialsActive || isEducationActive || isContactActive;
